...
import 'responsive_design/settings_desktop_layout.dart';
import 'responsive_design/settings_mobile_layout.dart';
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          final categoryManagement = Container(
          ...
          if (constraints.maxWidth > 800) {
            return SettingsDesktopLayout(
              categoryManagement: categoryManagement,
            );
          }
          return SettingsMobileLayout(
            categoryManagement: categoryManagement,
          );
        },
      ),
    ...
    showDialog(
      ...
      builder: (context) {
        return CustomDialog(
          ...
          onConfirm: () async {
            if (nombreController.text.isEmpty || prefijoController.text.isEmpty)
              return;
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: "Nombre Categoría (ej. Herramientas)",
